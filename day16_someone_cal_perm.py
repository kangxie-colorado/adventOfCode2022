...
# credit: https://github.com/davearussell/advent2022/blob/master/day16/solve.py
# I had the same idea but didn't think too deep into it
# was scared off when I see fac(15) > 1 Trillion
# I also thought there could be some early termination given the time limit
# but didn't figure it out how to do that
# luckily someone did this.. so I am researching
# this in essence is the iterative equivalence to the dfs solution I feel
...
def find_paths(edges, goal):
    """
    so this function is to find paths for all the nodes this goal can reach to
    it uses a heap
    this might just be the floyd washall algorithm s
    """
    q = [(0, goal)]
    path_lengths = {goal: 0}
    while q:
